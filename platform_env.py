...
class PlatformEnv(gym.Env):
    ...
    def __init__(self,type='normal'):
        ...
        self.enemy1 = Enemy(self.platform1,type)
    ...
    def save_render_states(self, dir = 'C:\\Users\\josen\\OneDrive\\Ambiente de Trabalho\\good\\project\\save_imgs', prefix='exp', index=0):
        self._initialse_window()
        import os
...
class Enemy:
    ...
    def __init__(self, platform, type= 'normal'):
...
class Player:
    ...
    def __init__(self, type='normal'):
        ...
        self.type = type
        if type == 'leap':
            self.position = np.array((150., Constants.PLATFORM_HEIGHT))
        else:
            self.position = np.array((0., Constants.PLATFORM_HEIGHT))
